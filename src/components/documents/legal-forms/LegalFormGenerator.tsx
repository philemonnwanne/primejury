...
export function LegalFormGenerator() {
    ...
    const generateDocument = async () => {
        ...
        try {
            ...
            if (description) {
                const generatedContent = await generateLegalContent(description, selectedDocType.label, {
                    ...
                    {selectedCase && (
                        <div className="space-y-2">
                            ...
                            <Select value={documentType} onValueChange={setDocumentType}>
                                ...
                                <SelectContent>
                                    {documentTypes.filter((type) => type.category === selectedCaseData?.type).map((type) => (
                    ...
                    {!isEditing ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-end space-x-2">
                                <Button variant="outline" onClick={() => setEditedContent(generatedContent)}>
                                    Reset to Original
                                </Button>
                                <PDFDownloadLink
                                    document={
